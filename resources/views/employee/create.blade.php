...
@section('content')
	<div class="container">
	    <div class="row justify-content-center">
	        <div class="col-md-8">
	            <div class="card">
	                <div class="card-header"><h1>Create Employee</h1></div>

	                <div class="card-body" style="width:80%;">
	                	<?= Form::open(['method'=>'post','route'=>'employee.store']) ?>
	                		...
	                		<div class="form-group">
	                			<label>Company: </label>
	                			<?= Form::select('company_id',[''=>'Select']+$company_list, null,['class' => 'form-control ','id'=>'company_id']); ?>
